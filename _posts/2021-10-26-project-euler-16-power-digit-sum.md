...
I'm satisfied with that function for now. I'm happy with the `multiply` method as it stands and the rest of the code. I do feel that I can do quite a lot with borrowing to save a lot more memory then I currently do. I'll extend on this article once I finally have the time to do so.
